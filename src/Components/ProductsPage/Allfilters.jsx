...
import {
  Box, Divider, Flex, Heading, VStack
...
const Allfilters = ({ handleGoBack, }) => {
  ...
  const [pageno] = useState(urlpage || 1);
  ...
  }, [categorytag, sortrange, brandrange, sortingByPrice, pageno, ratingplus, setSearchParams])
