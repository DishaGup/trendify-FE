import {
  Box, Breadcrumb, BreadcrumbItem, BreadcrumbLink, Button, GridItem, Divider, Flex, Grid, Heading, HStack, Select, Text,
  VStack,
...
const Sidebar = () => {
  ...
  let { productsData } = useSelector((store) => store.ProductReducer);
  ...
  let { totalPages, totalResults } = useSelector((store) => store.ProductReducer.productsData);
  ...
  }, [pageno, sortingByPrice, setSearchParams]);
